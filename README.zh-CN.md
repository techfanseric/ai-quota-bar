...
团队自助加入:队长在官网 /team 创建团队,成员凭邀请码和名字直接加入,支持可选成员口令。设置新增 App 内反馈表单,留言实时上墙。菜单当前 Codex 账号置顶并显示账号名,用量改为"本月 + 最近 24 小时"视图,订阅续费日在日历上标记;菜单与设置改用服务商品牌图标。

[官网](https://ai-quota-bar.pages.dev) · [更新日志](https://ai-quota-bar.pages.dev/changelog) · [完整 v1.18.0 发布说明](./docs/releases/v1.18.0.md)
