// Historical storage compatibility, not public routes. Writes are retained only for migration tests.
export async function storeQuotaSamples(request, env) {
...
export async function listQuotaSamples(url, env) {
...
export async function listAccountSummaries(url, env) {
...
export async function deleteDeviceData(url, env) {
